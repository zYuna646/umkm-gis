        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                    <a  style="margin-right: 2.5%" href="{{ route('admin.umkm.create') }}" class="btn btn-info d-flex align-items-center">
                        <i class="ti ti-plus text-white me-1 fs-5"></i> Tambah {{ $title ?? '' }}
                    </a>

                    <a href="{{ route('admin.umkm.create') }}" class="btn btn-success d-flex align-items-center"> <!-- Perubahan di sini -->
                        <i class="ti ti-plus text-white me-1 fs-5"></i> Export Excel
                    </a>
                </div>
            </div>
        </div>
